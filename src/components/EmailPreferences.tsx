      ...
      <CardContent className="space-y-6">
        ...
        {preferences?.email_enabled && (
          <>
            ...
            <div className="border-t pt-4">
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <Label htmlFor="digest-none" className="font-normal cursor-pointer">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Label htmlFor="digest-daily" className="font-normal cursor-pointer">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Label htmlFor="digest-weekly" className="font-normal cursor-pointer">
            ...
            {/* Email type toggles */}
            <div className="border-t pt-4">
              <h4 className="text-sm font-medium mb-4">Email Types</h4>
